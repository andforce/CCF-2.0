...
@interface BBSPayManager () <SKPaymentTransactionObserver, SKProductsRequestDelegate, SKRequestDelegate> {
...
@implementation BBSPayManager {

}

static BBSPayManager *_instance = nil;
