...
#import "FeiFanHtmlParser.h"
#import "BBSLocalApi.h"
#import "TranslateData.h"
#import "UIStoryboard+Forum.h"
#import "BBSWebViewController.h"

@implementation FeiFanBBSApi {
    FeiFanConfig *forumConfig;
    FeiFanHtmlParser *forumParser;
}
...
- (instancetype)init {
    self = [super init];
    if (self) {
        forumConfig = [[FeiFanConfig alloc] init];
        forumParser = [[FeiFanHtmlParser alloc] init];
    }
    return self;
}
