...
@implementation ChiphellForumApi {

    ChiphellConfig *forumConfig;
    ChiphellHtmlParser *forumParser;
...
- (instancetype)init {
    self = [super init];
    if (self) {
        forumConfig = [[ChiphellConfig alloc] init];
        forumParser = [[ChiphellHtmlParser alloc] init];
    }
    return self;
}
