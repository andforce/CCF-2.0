...
@implementation Et8NetApi {
    ...
    Et8NetConfig *forumConfig;
    Et8NetHtmlParser *forumParser;
}

- (instancetype)init {
    self = [super init];
    if (self) {
        forumConfig = [[Et8NetConfig alloc] init];
        forumParser = [[Et8NetHtmlParser alloc] init];
    }
    return self;
}
